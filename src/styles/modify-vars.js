const mainColor = '#050d3f';

const mainBtnBackground = '#050d3f';
const mainDisabledBtnBackground = '#050d3f';

const secondaryBtnBackground = '#41414f';

// font
const defaultBtnColor = '#22222a';

module.exports = {
  '@text-color': '#383838',
  '@color-text-base-inverse': '#fff',
  '@text-color-secondary': '#686868',
  '@color-text-placeholder': '#989898',
  '@color-text-disabled': '#686868',
  '@color-text-caption': '#686868',
  '@color-text-paragraph': '#383838',
  '@link-color': '#41414f',
  // background color
  '@fill-mask': 'rgba(0, 0, 0, 0.7)',
  '@fill-body': '#f5f5f5',
  // brand color
  // '@primary-color': '#050d3f',
  '@brand-primary-tap': '#050d3f',
  // border
